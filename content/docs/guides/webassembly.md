...
```
docker run -v $GOPATH:/go -e "GOPATH=/go" ghcr.io/tinygo-org/tinygo:0.27.0 /bin/bash -c "cp /usr/local/tinygo/targets/wasm_exec.js /go/src/github.com/myuser/myrepo/
```
