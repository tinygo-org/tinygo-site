...
The [Grand Central M4](https://www.adafruit.com/product/4064) is a tiny ARM development board based on the Atmel [ATSAMD51P20](https://www.microchip.com/wwwproducts/en/ATSAMD51P20A) family of SoC.

## Peripherals and Drivers

- [WS2812](https://pkg.go.dev/tinygo.org/x/drivers/ws2812) Neopixel via the `PC24` pin
