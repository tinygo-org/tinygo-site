...
```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.40.0/tinygo_0.40.0_amd64.deb
sudo dpkg -i tinygo_0.40.0_amd64.deb
```

If you are on a Raspberry Pi or other ARM-based Linux computer, you should use this command instead:

```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.40.0/tinygo_0.40.0_armhf.deb
sudo dpkg -i tinygo_0.40.0_armhf.deb
```
...
```shell
$ tinygo version
tinygo version 0.40.0 linux/amd64 (using go version go1.25.5 and LLVM version 20.1.1)
```
