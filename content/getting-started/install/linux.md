...
```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.37.0/tinygo_0.37.0_armhf.deb
sudo dpkg -i tinygo_0.37.0_armhf.deb
```
...
```shell
$ tinygo version
tinygo version 0.37.0 linux/amd64 (using go version go1.24.1 and LLVM version 19.1.2)
```
