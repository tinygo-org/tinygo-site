...
```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.42.0/tinygo_0.42.0_armhf.deb
sudo dpkg -i tinygo_0.42.0_armhf.deb
```
...
```shell
$ tinygo version
tinygo version 0.42.0 linux/amd64 (using go version go1.27.0 and LLVM version 22.1.4)
```
...
Scroll down on that page to the "Artifacts" and click to download the file for your desired architecture, for example `tinygo0.42.0-dev.linux-amd64.tar.gz`.
