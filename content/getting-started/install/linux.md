...
```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.41.1/tinygo_0.41.1_armhf.deb
sudo dpkg -i tinygo_0.41.1_armhf.deb
```
...
Scroll down on that page to the "Artifacts" and click to download the file for your desired architecture, for example `tinygo0.41.1-dev.linux-amd64.tar.gz`.
