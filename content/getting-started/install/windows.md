...
```shell
> tinygo version
tinygo version 0.27.0 windows/amd64 (using go version go1.20 and LLVM version 15.0.0)
```
...
- Download the TinyGo binary for Windows file from https://github.com/tinygo-org/tinygo/releases/download/v0.27.0/tinygo0.27.0.windows-amd64.zip
