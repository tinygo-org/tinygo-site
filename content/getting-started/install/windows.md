...
```shell
> tinygo version
tinygo version 0.37.0 windows/amd64 (using go version go1.24.1 and LLVM version 19.1.2)
```
...
- Download the TinyGo binary for Windows file from https://github.com/tinygo-org/tinygo/releases/download/v0.37.0/tinygo0.37.0.windows-amd64.zip
