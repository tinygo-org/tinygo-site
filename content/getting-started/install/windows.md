...
```shell
> tinygo version
tinygo version 0.34.0 windows/amd64 (using go version go1.23 and LLVM version 18.1.2)
```
...
- Download the TinyGo binary for Windows file from https://github.com/tinygo-org/tinygo/releases/download/v0.34.0/tinygo0.34.0.windows-amd64.zip
