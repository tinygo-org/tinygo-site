...
```shell
> tinygo version
tinygo version 0.21.0 windows/amd64 (using go version go1.17s and LLVM version 11.0.0)
```
...
- Download the TinyGo binary for Windows file from https://github.com/tinygo-org/tinygo/releases/download/v0.21.0/tinygo0.21.0.windows-amd64.zip
