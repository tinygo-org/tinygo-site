...
```shell
> tinygo version
tinygo version 0.40.0 windows/amd64 (using go version go1.25.5 and LLVM version 20.1.1)
```
...
- Download the TinyGo binary for Windows file from https://github.com/tinygo-org/tinygo/releases/download/v0.40.0/tinygo0.40.0.windows-amd64.zip
