...
```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.14.0/tinygo_0.14.0_amd64.deb
sudo dpkg -i tinygo_0.14.0_amd64.deb
```
...
```shell
$ tinygo version
tinygo version 0.14.0 linux/amd64
```
