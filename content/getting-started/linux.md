...
```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.11.0/tinygo_0.11.0_armhf.deb
sudo dpkg -i tinygo_0.11.0_armhf.deb
```
...
```shell
$ tinygo version
tinygo version 0.11.0 linux/amd64
```
