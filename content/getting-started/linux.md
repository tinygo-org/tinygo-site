...
```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.10.0/tinygo_0.10.0_amd64.deb
sudo dpkg -i tinygo_0.10.0_amd64.deb
```

If you are on a Raspberry Pi or other ARM-based Linux computer, you should use this command instead:

```shell
wget https://github.com/tinygo-org/tinygo/releases/download/v0.10.0/tinygo_0.10.0_armhf.deb
sudo dpkg -i tinygo_0.10.0_armhf.deb
```
...
```shell
$ tinygo version
tinygo version 0.10.0 linux/amd64
```
